...
let timeout = process.env.DEBUG ? 99999999 : 100000;
...
exports.config = {
    ...
    //services: ['selenium-standalone','chromedriver','browserstack'],
   // services: ['chromedriver', [TimelineService]],
    ...
    //reporters: ['dot','spec','allure','video'],
    reporters: ['dot', 'spec',
                ['timeline', {
    ...
    onPrepare: function (config, capabilities) {
        ...
        // del(['allure-report','reports', 'video-results','allure-results','errorShots']);
        del(['test-report/*.jpeg', 'test-report/*.txt', 'test-report/*.log', 'test-report/*.html']);
    },
    // onPrepare: function (config, capabilities) {
    // },
    /**
